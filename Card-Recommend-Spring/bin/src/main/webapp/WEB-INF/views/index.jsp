...
<section class="pt-8 py-lg-0" id="hero">
  ...
  <div class="container-xxl">
    <div class="row align-items-center min-vh-lg-75">
      <%-- <div class="col-lg order-lg-1 text-center"><img class="img-fluid" src="${pageContext.request.contextPath }/resources/assets/img/illustrations/hero.png" alt="" /></div> --%>
      <div class="col-lg mt-5 mt-lg-0">
        <h1 class="lh-sm fs-6 fs-sm-8 fs-md-11 fs-lg-9 fs-xl-11 fs-xxl-12">HANA CARD <br class="d.none d-xl-block" /></h1>
        <p class="mt-4 fs-2 fs-md-4 lh-sm"></p>
    ...
    <div class="row row-cols-1 row-cols-xl-3 g-4 mt-3 text-center">
      <div class="col-12 col-md-6">
        <div class="card py-md-6 px-md-4 mt-3 h-100 box-shadow-all border-0">
          <div class="card-body"><img src="${pageContext.request.contextPath }/resources/assets/img/icons/icon1.png" alt="" />
      ...
      <div class="col-12 col-md-6">
        <div class="card py-md-6 px-md-4 mt-3 h-100 box-shadow-all border-0">
          <div class="card-body"><img src="${pageContext.request.contextPath }/resources/assets/img/icons/icon2.png" alt="" />
      ...
      <div class="col-12">
        <div class="card py-md-6 px-md-4 mt-3 h-100 box-shadow-all border-0">
          <div class="card-body"><img src="${pageContext.request.contextPath }/resources/assets/img/icons/icon3.png" alt="" />
...
<section id="contribute">
  ...
  <div class="container-xxl">
    <div class="row align-items-center">
      <div class="col-md-6"><img src="${pageContext.request.contextPath }/resources/assets/img/icons/icon1.png" alt="" />
      ...
      <div class="col-md-6 col-xl-4 offset-xl-1">
        <div class="card box-shadow-rb my-4">
          <div class="card-body my-3 mx-4">
            ...
            <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user1.png" alt="" height="70" />
              <div class="ms-3">
                <h3>Dillon Kydd</h3>
                <p class="mb-0">100 SHARES</p>
              </div>
            </div>
            <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user2.png" alt="" height="70" />
              <div class="ms-3">
                <h3>Anna Olsen</h3>
                <p class="mb-0">100 SHARES</p>
              </div>
            </div>
            <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user3.png" alt="" height="70" />
              <div class="ms-3">
                <h3>Kas Moss</h3>
                <p class="mb-0">100 SHARES</p>
              </div>
...
<section>
  ...
  <div class="container-xxl">
    <div class="row flex-between-center">
      <div class="col-md-6 order-md-1"><img src="${pageContext.request.contextPath }/resources/assets/img/icons/icon2.png" alt="" />
        ...
        <div class="card my-4">
          <div class="card-body p-0 p-lg-3 my-3 mx-4">
            <div class="card-title">
              <div class="d-flex align-items-center mt-3"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user4.png" alt="" height="70" />
                <div class="ms-3">
                  <h3>Jassir Jonis</h3>
...
<section>
  ...
  <div class="container-xxl">
    <div class="row align-items-center gx-1">
      <div class="col-xl-6"><img src="${pageContext.request.contextPath }/resources/assets/img/icons/icon3.png" alt="" />
        ...
        <div class="row justify-content-center gx-4">
            ...
            <div class="card px-3 py-4 bg-warning">
              <div class="card-body">
                ...
                <div class="applicant d-flex justify-content-between text-1000">
                  <div class="d-flex align-items-center"><img class="rounded-circle my-2 me-2 me-md-3" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user5.png" alt="" height="40" />
                    <p class="fs-1 fs-md-2 mb-0 fw-semi-bold">Jason Kwon</p>
                  </div>
                  <div class="d-flex align-items-center"><img class="star" src="${pageContext.request.contextPath }/resources/assets/img/icons/star.svg" alt="" />
                    <p class="mb-0 mx-2 fw-medium">4.8</p>
                  </div>
                </div>
                <div class="applicant d-flex justify-content-between text-1000">
                  <div class="d-flex align-items-center"><img class="rounded-circle my-2 me-2 me-md-3" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user6.png" alt="" height="40" />
                ...
                <div class="applicant d-flex justify-content-between text-1000">
                  <div class="d-flex align-items-center"><img class="rounded-circle my-2 me-2 me-md-3" src="${pageContext.request.contextPath }/resources/assets/img/gallery/user7.png" alt="" height="40" />
          ...
          <div class="col-sm-12 col-md-5">
            <div class="card p-2 mt-4 mt-md-5 border-success">
              <div class="card-body">
                <div class="card-text text-center"><img class="rounded-circle" src="${pageContext.request.contextPath }/resources/assets/img/gallery/axel.png" alt="" height="70" />
...
<section id="rea">
  ...
  <div class="container-xxl">
    <div class="row align-items-center">
      <div class="col-lg order-lg-1 text-center"><img class="img-fluid" src="${pageContext.request.contextPath }/resources/assets/img/illustrations/hero2.png" alt="" /></div>
      <div class="col-lg mt-5 mt-lg-0">
